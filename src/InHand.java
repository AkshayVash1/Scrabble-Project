 ...
 *
 * InHand class is primarily used to check if the word that the player intends on playing can be played based off
 * of the current status of their hand. This class is used to check this in the main Game class. This class is also
...
public class InHand implements Serializable {
    ...
    /**
     * InHand constructor that takes in a wordAttempt and the current player's hand to initialize the class state
