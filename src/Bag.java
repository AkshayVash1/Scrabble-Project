...
public class Bag {
    ...
    private Map<String, Integer> pointValueMap = new HashMap<>();
    ...
    private void initialize() {
        ...
        for (String numOfLetter : numOfLetters) {
            ...
            for (int i = 0; i < Integer.parseInt(token[1]); i++) {
                tiles.add(new Tile(token[0], letterPointMap.get(token[0])));
            }
        }
        for (int i = 0; i < 2; i++) {
