...
public class Command {
    ...
    /**
     * Command constructor that takes in all the different parts of the command and initializes
     * the class state.
     * @param action for the action to be done
     * @param placementAttempt for the area in which the Tile will be placed
